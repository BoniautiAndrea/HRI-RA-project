...
(define (domain mini_full)
    ...
    (:action idle
        :parameters (?y_prev ?y ?y_next - y_value ?vy_prev ?vy - vy_value ?vx - vx_value ?vt - vt_value
            ?x_prev ?x ?x_next - x_value ?t_prev ?t ?t_next - t_value)
        :precondition (and 
            (current_y ?y) (current_vy ?vy) (current_t ?t) (current_vt ?vt) (current_x ?x) (current_vx ?vx)
            (prev ?y_prev ?y)
            (next ?y_next ?y)
            (prev ?vy_prev ?vy)
            (prev ?x_prev ?x)
    ...
    (:action main_engine
        :parameters (?y_prev ?y ?y_next - y_value ?vy ?vy_next - vy_value ?vx - vx_value ?vt - vt_value
            ?x_prev ?x ?x_next - x_value ?t_prev ?t ?t_next - t_value)
        :precondition (and 
            (current_y ?y) (current_vy ?vy) (current_t ?t) (current_vt ?vt) (current_x ?x) (current_vx ?vx)
            (prev ?y_prev ?y)
    ...
    (:action right_engine
        :parameters (?x_prev ?x ?x_next - x_value ?t_prev ?t ?t_next - t_value ?vx ?vx_next - vx_value ?vt_prev ?vt - vt_value
            ?y_prev ?y ?y_next - y_value ?vy - vy_value)
        :precondition (and 
            (current_x ?x) (current_t ?t) (current_vx ?vx) (current_vt ?vt) (current_y ?y) (current_vy ?vy)
            (prev ?x_prev ?x)
            (next ?x_next ?x)
            (prev ?t_prev ?t)
            (next ?t_next ?t)
    ...
    (:action left_engine
        :parameters (?x_prev ?x ?x_next - x_value ?t_prev ?t ?t_next - t_value ?vx_prev ?vx - vx_value ?vt ?vt_next - vt_value
            ?y_prev ?y ?y_next - y_value ?vy - vy_value)
        :precondition (and 
            (current_x ?x) (current_t ?t) (current_vx ?vx) (current_vt ?vt) (current_y ?y) (current_vy ?vy)
            (prev ?x_prev ?x)
